const modalContents = {
  1: {
    ...
    mission: "Perfectionnement de l'interface front-end & responsive.",
    paragraph:
  ...
  2: {
    ...
    mission:
      "Mise en place d'une API (Api Platform), d'un back end Symfony et un rendu en React.",
    paragraph:
  ...
  3: {
    ...
    subtext: "Projet perso",
    mission:
      "Ce site à été créer pour parfaire mes compétences sur React, Symfony et Api Platform.",
  ...
  4: {
    ...
    subtext: "Projet perso",
    mission: "Création d'un site vitrine simpliste.",
    paragraph:
  ...
  5: {
    ...
    mission: "Prise en main du logiciel Android studio.",
    paragraph:
  ...
  6: {
    ...
    mission:
      "Mise en place du Modèle Vue Controlleur, travail en équipe (4 personnes) en méthode agile.",
    paragraph:
  ...
  7: {
    ...
    subtext: "Projet perso",
    mission:
      "Mise en place d'un site e-commerce et une interface d'administration (CRUD, mail automatique panier d'achat).",
    paragraph:
      "Site E commerce créé pour parfaire mes compétences et principalement avec le framework Symfony.",
  },
};
